...
namespace ManejoPresupuestos.Servicios
{
    ...
    public class RepositorioCuentas: IRepositorioCuentas
    {
        ...
        public async Task Crear(Cuenta cuenta)
        {
            ...
            var id = await connection.QuerySingleAsync<int>("INSERT INTO Cuentas (Nombre, TipoCuentaId, Descripcion, Balance) VALUES (@Nombre, @TipoCuentaId, @Descipcion, @Balance); " +
                "SELECT SCOPE_IDENTTITY();", cuenta);
